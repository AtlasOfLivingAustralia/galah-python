...
galah is a Python interface to biodiversity data hosted by the Atlas of Living Australia (ALA). It is based off of the R package of the same name. With this package you can locate and download:
