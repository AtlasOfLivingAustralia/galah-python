...
TAXONCONCEPT_NAMES = {
    ...
    "Portugal": {"guid": "usageKey", "author": "author"},
    "Spain": {"guid": "taxonConceptID", "author": "author"},  # 'species': 'nameString',
...
VERNACULAR_NAMES = {
    ...
    "Portugal": ["vernacularName", "vernacularName"],
    "Spain": ["vernacularName", "vernacularName"],
