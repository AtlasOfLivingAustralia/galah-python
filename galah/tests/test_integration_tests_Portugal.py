...
def test_show_all_apis_portugal():
    galah.galah_config(atlas="Portugal")
    output = galah.show_all(apis=True)
    assert output.shape[1] > 1

def test_show_all_collection_portugal():
    galah.galah_config(atlas="Portugal")
    output = galah.show_all(collection=True)
    assert output.shape[1] > 1

def test_show_all_datasets_portugal():
    galah.galah_config(atlas="Portugal")
...
def test_show_all_ranks_portugal():
    galah.galah_config(atlas="Portugal")
...
def test_search_taxa_portugal():
    galah.galah_config(atlas="Portugal")
    output = galah.search_taxa("Anser anser")
...
def test_atlas_counts_filters_portugal():
    galah.galah_config(atlas="Portugal")
    f = "year=2022"
...
# testing filtering works when no taxa are entered
def test_atlas_counts_filters_groupby_expand_portugal():
    galah.galah_config(atlas="Portugal")
    f = "year=2022"
...
# testing filtering works when no taxa are entered
def test_atlas_counts_filters_groupby_portugal():
    galah.galah_config(atlas="Portugal")
    f = "year=2022"
    groups = ["month","basis_of_record"]
...
def test_atlas_counts_taxa_filter_portugal():
    galah.galah_config(atlas="Portugal")
    taxa = "Anser anser"
    filter1 = "year=2020"
...
def test_atlas_counts_taxa_filter_empty_portugal():
    galah.galah_config(atlas="Portugal")
    taxa = "Anser anser"
    filter1 = "year="
...
def test_astlas_counts_taxa_same_filter_portugal():
    galah.galah_config(atlas="Portugal")
    taxa = "Anser anser"
...
# test atlas_counts() can call search_taxa() and using two filters with the same field, return results for a single taxa
def test_atlas_counts_taxa_same_filter_portugal():
    galah.galah_config(atlas="Portugal")
    taxa = "Anser anser"
...
def test_atlas_counts_multiple_taxa_filters_separate_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Anser anser", "Branta hutchinsii","Aythya affinis"]
...
def test_atlas_counts_taxa_group_portugal():
    galah.galah_config(atlas="Portugal")
    taxa = "Anser anser"
    group_by = "year"
...
def test_atlas_counts_taxa_groups_portugal():
    galah.galah_config(atlas="Portugal")
    taxa = "Anser anser"
...
def test_atlas_counts_taxa_groups_expand_portugal():
    galah.galah_config(atlas="Portugal")
    taxa = "Anser anser"
    group_by = ["year","basis_of_record"]
    output = galah.atlas_counts(taxa,group_by=group_by)
...
def test_atlas_counts_taxa_filters_portugal():
    galah.galah_config(atlas="Portugal")
    taxa = "Anser anser"
...
def test_atlas_counts_taxa_filters_group_by_no_expand_portugal():
    galah.galah_config(atlas="Portugal")
    taxa = "Anser anser"
    filters=["year=2020","basis_of_record=HumanObservation"]
...
def test_atlas_counts_multiple_taxa_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Quiscalus mexicanus", "Anser anser", "Turdus grayi", "Melanerpes aurifrons"]
...
# test atlas_counts() can call search_taxa() function with multiple taxa
def test_atlas_counts_multiple_taxa_group_by_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Quiscalus mexicanus", "Anser anser", "Turdus grayi", "Melanerpes aurifrons"]
    group_by=["year",'basis_of_record']
    output = galah.atlas_counts(taxa_array,group_by=group_by)
...
def test_atlas_counts_multiple_taxa_filter_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Quiscalus mexicanus", "Anser anser", "Turdus grayi", "Melanerpes aurifrons"]
    filter1 = "year=2020"
...
# test altas_counts() can call search_taxa() and using one filter, filter results with multiple taxa
def test_atlas_counts_multiple_taxa_filter_group_by_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Quiscalus mexicanus", "Anser anser", "Turdus grayi", "Melanerpes aurifrons"]
    filter1 = "year=2020"
    group_by="basis_of_record"
...
# test altas_counts() can call search_taxa() and using one filter, filter results with multiple taxa
def test_atlas_counts_multiple_taxa_filters_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Quiscalus mexicanus", "Anser anser", "Turdus grayi", "Melanerpes aurifrons"]
    filters = ["year=2020", "basis_of_record=HumanObservation"]
...
# test altas_counts() can call search_taxa() and using one filter, filter results with multiple taxa
def test_atlas_counts_multiple_taxa_filters_group_by_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Quiscalus mexicanus", "Anser anser", "Turdus grayi", "Melanerpes aurifrons"]
    filters = ["year=2020", "basis_of_record=HumanObservation"]
    group_by = "year"
...
# test altas_counts() can call search_taxa() and using one filter, filter results with multiple taxa
def test_atlas_counts_multiple_taxa_filters_group_by_multiple_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Quiscalus mexicanus", "Anser anser", "Turdus grayi", "Melanerpes aurifrons"]
...
# test atlas_counts() can call search_taxa() and separate the counts for multiple taxa where one taxon is not present in Portugal
def test_atlas_counts_invalid_multiple_taxa_separate_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Quiscalus mexicanus", "Anser anser", "Turdus grayi"]
...
def test_atlas_counts_multiple_taxa_separate_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Aythya affinis", "Anser anser", "Columba oenas", "Tachybaptus ruficollis"]
    output = galah.atlas_counts(taxa_array, group_by="species")
...
def test_atlas_counts_multiple_taxa_filters_separate_portugal2():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Aythya affinis", "Anser anser", "Columba oenas", "Tachybaptus ruficollis"]
    f = ["year>=2000", "month=11"]
...
def test_atlas_counts_multiple_taxa_filters_group_by_separate_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Aythya affinis", "Anser anser", "Columba oenas", "Tachybaptus ruficollis"]
...
# test altas_counts() can call search_taxa() and using one filter, filter and group results with multiple taxa separated
def test_atlas_counts_multiple_taxa_filter_group_by_multiple_separate_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Aythya affinis", "Anser anser", "Columba oenas", "Tachybaptus ruficollis"]
...
# test altas_counts() can call search_taxa() and using one filter, filter and group results with multiple taxa separated
def test_atlas_counts_multiple_taxa_filters_group_by_multiple_separate_expand_portugal():
    galah.galah_config(atlas="Portugal")
    taxa_array = ["Aythya affinis", "Anser anser", "Columba oenas", "Tachybaptus ruficollis"]
    f = ["basis_of_record=HumanObservation", "year>=2019"]
    group_by = ["year", "month"]
...
def test_atlas_species_Portugal_species_portugal():
    galah.galah_config(atlas="Portugal")
    taxa = "Aythya"
...
# checking if atlas species can successfully call search_taxa() and get a non-empty dataframe\
def test_atlas_species_Portugal_family_portugal():
    galah.galah_config(atlas="Portugal")
    taxa = "Icteridae"
    species_table = galah.atlas_species(taxa=taxa)
    assert species_table.shape[0] > 0
...
def test_search_all_atlases_portugal():
    galah.galah_config(atlas="Portugal")
    total_show_all = galah.show_all(atlases=True)
    total_search_all = galah.search_all(atlases="Portugal")
    assert total_search_all.shape[0] < total_show_all.shape[0]

# search_all() - atlases using "Portugal" and column name "institution"
def test_search_all_atlases_column_name_portugal():
    galah.galah_config(atlas="Portugal")
    total_show_all = galah.show_all(atlases=True)
    total_search_all = galah.search_all(atlases="Portugal",column_name="institution")
    assert total_search_all.shape[0] < total_show_all.shape[0]

# search_all() - apis using "Portugal"
def test_search_all_apis_portugal():
    galah.galah_config(atlas="Portugal")
    total_show_all = galah.show_all(apis=True)
    total_search_all = galah.search_all(apis="Portugal")
    assert total_search_all.shape[0] < total_show_all.shape[0]
    
# search_all() - apis using "collection" and column name "systems"
def test_search_all_apis_column_name_portugal():
    galah.galah_config(atlas="Portugal")
    total_show_all = galah.show_all(apis=True)
...
def test_search_all_collection_portugal():
    galah.galah_config(atlas="Portugal")
...
def test_search_all_collection_column_name_portugal():
    galah.galah_config(atlas="Portugal")
    total_show_all = galah.show_all(collection=True)
...
def test_search_all_datasets_portugal():
    galah.galah_config(atlas="Portugal")
...
def test_search_all_datasets_column_name_portugal():
    galah.galah_config(atlas="Portugal")
    total_show_all = galah.show_all(datasets=True)
...
# def test_search_all_providers_portugal():
#     galah.galah_config(atlas="Portugal")
...
# def test_search_all_providers_column_name_portugal():
#     galah.galah_config(atlas="Portugal")
#     total_show_all = galah.show_all(providers=True)
...
def test_search_all_ranks_portugal():
    galah.galah_config(atlas="Portugal")
...
def test_search_all_ranks_column_name_portugal():
    galah.galah_config(atlas="Portugal")
    total_show_all = galah.show_all(ranks=True)
...
def test_search_all_reasons_portugal():
    galah.galah_config(atlas="Portugal")
...
def test_search_all_reasons_column_name_portugal():
    galah.galah_config(atlas="Portugal")
    total_show_all = galah.show_all(reasons=True)
    total_search_all = galah.search_all(reasons="0",column_name="id")
    assert total_search_all.shape[0] < total_show_all.shape[0]

def test_search_values_portugal():
    galah.galah_config(atlas="Portugal")
...
'''
# first test for atlas_occurrences_portugal() - check if search_taxa() is working
def test_atlas_occurrences_taxa_portugal():
    galah.galah_config(atlas="Portugal",email="test@ala.org.au")
    occurrences = galah.atlas_occurrences(taxa="Anser anser")
    assert occurrences.shape[0] > 1

# second test for atlas_occurrences_portugal() - check if galah_select() is working
def test_atlas_occurrences_taxa_fields_portugal():
    galah.galah_config(atlas="Portugal",email="test@ala.org.au")
    occurrences = galah.atlas_occurrences(taxa="Anser anser",fields=['decimalLatitude', 'decimalLongitude'])
    # columns
    assert occurrences.shape[1] == 2

# third test for atlas_occurrences() - check if galah_filter() is working with this
def test_atlas_occurrences_taxa_filters_portugal():
    galah.galah_config(atlas="Portugal",email="test@ala.org.au")
    occurrences1 = galah.atlas_occurrences(taxa="Anser anser")
    occurrences2 = galah.atlas_occurrences(taxa="Anser anser",filters="year=2020")
...
def test_atlas_occurrences_taxa_filter_fields_portugal():
    galah.galah_config(atlas="Portugal",email="test@ala.org.au")
    occurrences = galah.atlas_occurrences(taxa="Anser anser",filters="year=2020",fields=['decimalLatitude', 'decimalLongitude'])
    assert occurrences.shape[1] == 2
...
def test_atlas_occurrences_taxa_filters_portugal():
    ...
    occurrences1 = galah.atlas_occurrences(taxa="Anser anser")
    occurrences2 = galah.atlas_occurrences(taxa="Anser anser",filters=filters)
    assert occurrences2.shape[0] < occurrences1.shape[0]

# testing atlas occurrences with multiple filters and fields
def test_atlas_occurrences_taxa_filters_fields_portugal():
    galah.galah_config(atlas="Portugal",email="test@ala.org.au")
    occurrences = galah.atlas_occurrences(taxa="Anser anser",filters=["year>2018","basis_of_record=HumanObservation"],
