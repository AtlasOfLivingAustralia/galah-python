...
def test_galah_group_by_filter_australia():
    ...
    group_by1 = ['year']
    filters1 = 'year>2010'
    output = galah.galah_group_by(
        URL='https://biocache-ws.ala.org.au/ws/occurrences/search?disableAllQualityfilters=true&',
        method='GET',
        group_by=group_by1,
        filters=filters1,
        payload=payload,
...
def test_atlas_occurrences_mint_doi():
    galah.galah_config(atlas='Australia', email='amanda.buyan@csiro.au')  # ala4r@ala.org.au
