...
'''
initial comments - get all of the species occurrences 
'''
...
get the count of the number of records of specified species

TODO: add facets/filters (do this later)
...
RETURNS: 
dataFrame: a dataframe containing the species name and total number of records for that species.  Can be
           separated into multiple species with the separate argument
'''
